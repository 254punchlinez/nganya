...
import { User, Mail, CalendarDays, Car } from "lucide-react"
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow container mx-auto px-4 py-8 md:py-12">
        <section className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold gradient-text mb-4 animate-fade-in-up">
          ...
          >
            Your personalized space to manage your account and explore cars.
          </p>
        </section>
        ...
        <Card className="w-full max-w-2xl mx-auto shadow-medium">
          <CardHeader className="text-center">
            ...
            <CardDescription className="text-muted-foreground">Quick overview of your account.</CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              {/* Add more dashboard specific details here */}
            </div>
            <Separator />
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Button asChild className="btn-hero">
                <Link to="/cars">
                  Browse Cars <Car className="ml-2 h-5 w-5" />
                </Link>
              </Button>
