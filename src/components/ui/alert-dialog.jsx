...
const AlertDialogAction = React.forwardRef(function AlertDialogAction({ className, ...props }, ref) {
  return (
    <AlertDialogPrimitive.Action
      ref={ref}
      className={cn(cva(Button.displayName, { variants: { variant: { default: "" } } })(), className)}
      {...props}
    />
  )
})
...
const AlertDialogCancel = React.forwardRef(function AlertDialogCancel({ className, ...props }, ref) {
  return (
    <AlertDialogPrimitive.Cancel
      ref={ref}
      className={cn(cva(Button.displayName, { variants: { variant: { outline: "" } } })(), "mt-2 sm:mt-0", className)}
      {...props}
    />
  )
})
